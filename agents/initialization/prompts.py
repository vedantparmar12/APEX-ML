"""Prompts for the Initialization Agent"""
...
class InitializationPrompts:
    ...
    def get_summarization_prompt(self, task_description: str, task_type: str) -> str:
        """Get prompt for task summarization"""
...
- Focus on the key aspects: input features, target variable, and evaluation metric.
- Maximum 3-4 sentences."""

    def get_model_retrieval_prompt(self, task_summary: str, num_candidates: int) -> str:
        """Get prompt for model retrieval"""
...
- Focus on state-of-the-art models that have proven success in similar tasks.

# Requirement
- The example code should be concise and simple.
- You must provide an example code, i.e., do not just mention GitHubs or papers.
- Include models like XGBoost, LightGBM, CatBoost, Neural Networks, or ensemble methods.
...
Return: list[Model]"""
    ...
    def get_model_eval_prompt(self, task_description: str, model_name: str, example_code: str) -> str:
        """Get prompt for model evaluation"""
...
- Do not use try: and except: or if else to ignore unintended behavior."""
    ...
    def get_code_integration_prompt(self, base_code: str, reference_code: str) -> str:
        """Get prompt for code integration"""
...
- When integrating, ensemble the models using techniques like voting, averaging, or stacking.
...
- Do not use try: and except: or if else to ignore unintended behavior."""
    ...
    def get_bug_summary_prompt(self, error: str) -> str:
        """Get prompt for bug summarization"""
...
- Focus on the key error message and where it occurred.
- Keep the essential information for debugging."""

    def get_bug_fix_prompt(self, task_description: str, code: str, bug: str) -> str:
        """Get prompt for bug fixing"""
